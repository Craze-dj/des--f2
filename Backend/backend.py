...
PINATA_SECRET_API_KEY = "0c0684eca8d39a7ff57ddab23b4b2eed2ec2d557ce4edde9836109e083b6c3a8"
...
def upload_file():
    ...
    if response.status_code == 200:
        ...
        try:
            ...
            print(f"File {file.filename} uploaded successfully to IPFS")
        except Exception as e:
        ...
        files = [
            {
                ...
                "upload_date": file.get('upload_date', datetime.now(timezone.utc)).isoformat(),
